...
const employee = new Employee('Dave', 'Smith', 'dsmith@gmail.com', 35)
...
const manager = new Manager('Bob', 'Burger', 'gooburger@yahoo.com', 45)
...
class ProgressiveManager extends Manager{
  ...
  updateTitle(){
    ...
    if(reportsLength === 0){
      this.title = 'Not a manager'
    }else if (reportsLength >= 1 && reportsLength <= 3)this.title = 'Barely Manager'
    else if(reportsLength >= 4 && reportsLength <= 10)this.title = 'Mostly Manager'
    else if(reportsLength >= 11 && reportsLength <= 50)this.title ='Manager'
    else if(reportsLength >= 51 && reportsLength <= 100)this.title = 'Manager Plus'
